...
bool QtWindow::configInitImpl()
{
	...
	if (getIAttribute(eq::Window::IATTR_HINT_STEREO) == eq::ON || (getIAttribute(eq::Window::IATTR_HINT_STEREO) == eq::AUTO && getIAttribute(eq::Window::IATTR_HINT_DRAWABLE) == eq::WINDOW))
	{
	...
	if (getIAttribute(eq::Window::IATTR_HINT_DOUBLEBUFFER) == eq::ON || (getIAttribute(eq::Window::IATTR_HINT_DOUBLEBUFFER) == eq::AUTO && getIAttribute(eq::Window::IATTR_HINT_DRAWABLE) == eq::WINDOW))
	{
	...
	{
		EQWARN << "Unsupported drawable type " << getIAttribute(eq::Window::IATTR_HINT_DRAWABLE) << "for QtWindow, creating a window" << std::endl;
	}
